...
$sql="INSERT INTO feedback(uname, email, message) VALUES ('".$uname."','".$email."', '".$message."')";
...
<div class="container">
  <div class="row">
    <div class="col">
    <form class="formjay" action ="#" method="POST">
...
<br>
  ...
  <button type="submit" class="btn btn-secondary btn_" id = "submit" name="submit">Submit</button>
</form>
    </div>
    <div class="col">
      <div class ="formjay">
